    ...
    <div className="h-[70%] relative">
      ...
      <form className="h-full w-full rounded-t-[60px] bg-form p-6 py-12 flex flex-col gap-6">
        ...
        <div className="flex gap-2">
          ...
          <button
            className="flex items-center justify-center gap-3 w-full max-w-xs px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none transition-colors"
          >
